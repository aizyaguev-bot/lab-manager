...
window.MOCK_DATA = {
  ...
  pdus: [
    ...
    },
    {
      ...
      firmware: "—",
      inletVoltage: 208,
      alerts: ["Port 23 conflict: Opt41 and Optn87 both assigned here — verify correct port for Optn87"],
      outlets: buildOutlets(24, {
        13: "Optn93",
        17: "Opt250",
        20: "Optn114",
        22: "Optn101",
        23: "Opt41",
        // Optn87 also listed at port 23 — placed at port 15 as placeholder until confirmed
        15: "⚠ Optn87 (port unconfirmed)",
      }),
    },
  ],
